...
urlpatterns = [
    ...
    path(
        'reports-user-list/',
        ReportsForUser.as_view(),
        name='reports_user_list',
    ),
    path(
    ...
    path(
        'record-for-staff/<int:pk>',
        RecordForStaff.as_view(),
        name='record-for-staff',
    ),
    path('record-add-memder/', AddRecordMember, name='record-add-member'),
    path(
        'record-delete-memder/',
        DeleteRecordMember,
        name='record-delete-member',
    ),
    path(
        'record-delete remark/',
        DeleteRecordRemark,
        name='record-delete-remark',
    ),
    path('record-verified/', RecordVerified, name='record-verified'),
    path(
        'record-cancel-verified/',
        RecordCancelVerified,
        name='record-cancel-verified',
    ),
    path(
        'record-delete-staff/', RecordDeleteStaff, name='record-delete-staff'
    ),
    path(
        'record-part-delete-staff/',
        RecordPartStaffDelete,
        name='record-part-delete-staff',
    ),
    # ремонт, работа пользователя
    path('record-add/<int:report_pk>',
        RecordAdd.as_view(),
        name='record_add_page',
    ),
    path('record-add/<int:report_pk>/<int:act_pk>',
        RecordAdd.as_view(),
        name='record_add_page',
    ),
    path('record-update/<int:pk>',
        RecordUpdate.as_view(),
        name='record_update_page',
    ),
    ...
    path('ajax/work-price-load/',
        load_work_price_data,
        name='ajax_load_work-price',
    ),
    path('user-ordered-parts/', OrderedParts.as_view(), name='ordered-parts'),
    path('staff-ordered-parts/',
        StaffOrderedParts.as_view(),
        name='staff-ordered-parts',
    ),
    path('send-parts/', SendParts, name='send-parts'),
    path('parts-to-xls/<int:center_pk>',
        ExportPartsToXLS.as_view(),
        name='parts-to-xls',
    ),
