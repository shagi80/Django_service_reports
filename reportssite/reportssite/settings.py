...
ALLOWED_HOSTS = ['shagi80.beget.tech', 'renova-service.ru', 'www.renova-service.ru']
...
INSTALLED_APPS = [
    ...
    'non_repairability_act.apps.NonRepairabilityActConfig',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, '..' , 'reportssite/templates'),],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
